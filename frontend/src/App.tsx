...
export default function App() {
  ...
  useEffect(() => { setDetailsDraft({ comment: current?.comment || '', link: current?.link || '' }); setDetailsOpen(Boolean(current?.comment || current?.link)); }, [current?.runtimeId]);
  useEffect(() => {
